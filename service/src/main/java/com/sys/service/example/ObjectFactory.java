...
public class ObjectFactory {
    ...
    private final static QName _SayHelloResponseReturn_QNAME = new QName(ServerConst.namespaceURI, "return");
     ...
     * 
     */
    @XmlElementDecl(namespace = ServerConst.namespaceURI, name = "return", scope = SayHelloResponse.class)
